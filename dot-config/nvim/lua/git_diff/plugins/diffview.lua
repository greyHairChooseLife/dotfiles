        ...
        require("diffview").setup({
            ...
            keymaps = {
                ...
                view = {
                    ...
                    { "n", "cp", actions.prev_conflict, { desc = "In the merge-tool: jump to the previous conflict" } },
                    { "n", "cn", actions.next_conflict, { desc = "In the merge-tool: jump to the next conflict" } },
