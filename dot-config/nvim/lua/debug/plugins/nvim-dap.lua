return {
    {
        ...
        keys = {
            ...
            {
                "<Space>dc",
                function() require("dapui").continue() end,
            },
            {
                "<Space>dt",
        ...
        config = function()
            ...
            if status then vim.keymap.set("n", "<Space>dp", dapuiwidgets.hover) end
            ...
            dap.listeners.after.event_initialized["dapui_config"] = function()
                ...
                dapui.open()
                vim.defer_fn(function() require("utils").switch_to_normal_mode() end, 100)
            end
            ...
            dap.configurations.c = {
                {
                    ...
                    type = "codelldb",
                    request = "launch",
                    program = function() return vim.fn.input("Path to executable: " .. vim.fn.getcwd() .. "/") end,
                    cwd = "${workspaceFolder}",
                    terminal = "integrated",
                    stopOnEntry = false,
                },
