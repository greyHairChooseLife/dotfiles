...
local layout = {
    ...
    preset = function() return vim.o.columns >= 120 and "default" or "full_dropdown" end,
}
local layouts = {
    ...
    split_multi = function(picker)
        ...
        elseif #items >= 1 then
            for item_idx, item in ipairs(items) do
                ...
                if item_idx == 1 then g_util.save_cursor_position() end
            end
