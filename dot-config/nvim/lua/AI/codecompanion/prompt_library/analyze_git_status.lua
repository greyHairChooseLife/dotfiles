    ...
    prompts = {
        ...
        },
        {
            ...
            content = function()
                ...
                if handle_staged == nil and handle_unstaged == nil and handle_untracked == nil then return nil end
                ...
                if #unstaged > 0 then git_status = git_status .. "#### Unstaged Changes Start(`git diff`)\n````diff\n" .. unstaged .. "````\n\n" end
                if #untracked > 0 then
                    git_status = git_status .. "#### Untracked Files(`git ls-files --others --exclude-standard`)\n````plaintext\n" .. untracked .. "````\n\n"
                    ...
                    for _, file in ipairs(untracked_files) do
                        if file ~= "" then
                            ...
                            if s ~= "" then
                                git_status = git_status .. "##### Diff For Untracked File " .. file .. " (`" .. cmd .. "`)\n````diff\n"
