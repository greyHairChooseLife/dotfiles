function MyTabLine()
    ...
    for i = 1, vim.fn.tabpagenr("$") do
        ...
        -- userdata를 문자열로 변환
        if type(tabname) ~= "string" then tabname = (tostring(tabname) or "Tab ") .. i end

        -- 탭 이름이 최대 너비보다 길 경우 잘라냄
        if #tabname > max_width then tabname = string.sub(tabname, 1, max_width - 3) .. "..." end
        ...
        if i == vim.fn.tabpagenr() then
            ...
            if tabname:find("GV") then
                s = s .. "%" .. i .. "T" .. "%#TabLineGVBg#" .. "%#TabLineGVBg#" .. tabname .. "%#TabLineGVBorder#" .. "%#TabLineFill#"
            elseif tabname:find("sp:") or tabname:find("mv:") then
                s = s .. "%" .. i .. "T" .. "%#TabLineTempBg#" .. "%#TabLineTempBg#" .. tabname .. "%#TabLineTempBorder#" .. "%#TabLineFill#"
            elseif tabname:find("") then
                s = s .. "%" .. i .. "T" .. "%#TabLineGVBg#" .. "%#TabLineGVBg#" .. tabname .. "%#TabLineGVBorder#" .. "%#TabLineFill#"
            elseif tabname:find("Oil") then
                s = s .. "%" .. i .. "T" .. "%#TabLineOilBg#" .. "%#TabLineOilBg#" .. tabname .. "%#TabLineOilBorder#" .. "%#TabLineFill#"
            else
                s = s .. "%" .. i .. "T" .. "%#TabLineSelBg#" .. "%#TabLineSelBg#" .. tabname .. "%#TabLineSelBorder#" .. "%#TabLineFill#"
            end
        else
            -- inactive tab
        ...
        if i < vim.fn.tabpagenr("$") + 1 then s = s .. sep end
    end
...
function MyTabLine_width_flexible(MinimalLength, MaximumLength)
    ...
    for i = 1, vim.fn.tabpagenr("$") do
        ...
        if MinimalLength == "" or MinimalLength == 0 then MinimalLength = nil end
        if MaximumLength == "" or MaximumLength == 0 then MaximumLength = nil end

        -- 최대 길이 제한
        if MaximumLength and #tabname > MaximumLength then tabname = string.sub(tabname, 1, MaximumLength - 3) .. "..." end
