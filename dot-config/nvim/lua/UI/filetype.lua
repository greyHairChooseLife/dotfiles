...
vim.api.nvim_create_autocmd("FileType", {
    ...
    callback = function()
        ...
        setOpt("winhighlight", "Normal:NoteBackground,FloatBorder:NoteBorder,FloatTitle:NoteTitle,EndOfBuffer:NoteEOB,FoldColumn:NoteFoldColumn")
        setOpt("number", false)
...
vim.api.nvim_create_autocmd("FileType", {
    ...
    callback = function()
        -- options
        setOpt("winhighlight", "Normal:TerminalNormal,FoldColumn:TerminalSignColumn,SignColumn:TerminalSignColumn,EndOfBuffer:TerminalEOB")
    end,
})
