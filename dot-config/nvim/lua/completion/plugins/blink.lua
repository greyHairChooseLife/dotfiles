...
return {
    ...
    opts = {
        keymap = {
            preset = "none",
            ["<C-e>"] = {
                function(cmp) return bf.cancel(cmp) end,
                "fallback",
            },
            ["<Esc>"] = {
                function(cmp) bf.hide(cmp) end,
                "fallback",
            },
            ["<C-k>"] = {
                function(cmp) return bf.show(cmp, "buffer", true) end,
                "select_prev",
                "fallback",
            },
            ["<C-j>"] = {
                function(cmp) return bf.show(cmp, "lsp", true) end,
                "select_next",
                "fallback",
            },
            ["<A-o>"] = {
                function(cmp) return bf.toggle_documentation(cmp) end,
                "show_signature",
                "hide_signature",
                "fallback",
            },
            ...
            ["<C-n>"] = {
                function(cmp) return bf.next_provider(cmp) end,
                "fallback",
            },
            ["<C-p>"] = {
                function(cmp) return bf.prev_provider(cmp) end,
                "fallback",
            },
            ["<Enter>"] = {
                function(cmp) return bf.accept_and_enter(cmp) end,
                "snippet_forward",
                "fallback",
            },
            ["<Tab>"] = {
                function(cmp) return bf.super_tab(cmp) end,
                "snippet_forward",
                "fallback",
            },
