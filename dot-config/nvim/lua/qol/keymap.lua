...
map("v", ",Y", function() utils.copy_visual_reference() end)
map("n", "ypA", function() utils.copy_paths_in_tab("absolute") end)
map("n", "ypR", function() utils.copy_paths_in_tab("relative") end)
map("n", "ypF", function() utils.copy_paths_in_tab("filename") end)
map("n", "ypD", function() utils.copy_paths_in_tab("directory") end)
