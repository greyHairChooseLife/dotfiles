...
vim.keymap.set("t", "<A-C-]>", MoveTabRight, { buffer = true })
vim.keymap.set("t", "<A-C-[>", MoveTabLeft, { buffer = true })
-- FOCUS TABS
vim.keymap.set("t", "<A-]>", [[<C-\><C-n>gt]], { noremap = true, silent = true, buffer = true })
vim.keymap.set("t", "<A-[>", [[<C-\><C-n>gT]], { noremap = true, silent = true, buffer = true })
for i = 1, 9 do
